# Laboratórios Práticos (Google Colab)

Este diretório centraliza todos os notebooks práticos da trilha de Machine Learning. Cada laboratório foi desenvolvido para complementar os conceitos teóricos abordados nos guias específicos de cada módulo. 

Para uma imersão completa na fundamentação teórica, acesse o guia correspondente de cada módulo na navegação principal.

---
## Módulo 1: Fundamentos de Machine Learning
*[Entenda os colabs do módulo](https://github.com/EstevaoMO/machine-learning-aprendizadodemaquina/blob/main/01_fundamentos_de_ml/colabs/MAPA.md)*

* **[Fundamentos: Entendendo Estruturas e Dados](https://colab.research.google.com/github/EstevaoMO/machine-learning-aprendizadodemaquina/blob/main/01_fundamentos_de_ml/colabs/Fundamentos_de_Machine_Learning_Entendendo_Estruturas_e_Dados.ipynb)**  
  Apresentação prática da estrutura de dados numérica em formato vetorial e primeiros comandos para manipulação matricial com bibliotecas fundamentais.
* **[Análise Gráfica: Exploração Visual e a Formulação de Hipóteses](https://colab.research.google.com/github/EstevaoMO/machine-learning-aprendizadodemaquina/blob/main/01_fundamentos_de_ml/colabs/Explora%C3%A7%C3%A3o_Visual_e_a_Formula%C3%A7%C3%A3o_de_Hip%C3%B3teses.ipynb)**  
...
## Módulo 6: Árvores e Ensembles
* 

## Módulo 7: Redução de Dimensionalidade
* 
